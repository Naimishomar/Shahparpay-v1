            ...
            <div className="flex flex-col gap-4 h-full">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl md:text-2xl font-bold tracking-tight text-foreground">DMT Reports</h1>
                            <p className="text-xs md:text-sm text-muted-foreground">View your Domestic Money Transfer transactions.</p>
                        </div>
                    </div>

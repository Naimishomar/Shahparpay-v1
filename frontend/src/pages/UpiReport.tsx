...
const UpiReport = () => {
    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            try {
                ...
                const typeQuery = "&type=UPI";
                const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/dashboard/recent-transactions?limit=1000$"&type=UPI"`, {
    ...
    const handleDownloadCSV = () => {
        ...
        link.setAttribute("download", `UpiReport_${new Date().getTime()}.csv`);
    ...
    const handleDownloadPDF = () => {
        ...
        doc.save(`UpiReport_${new Date().getTime()}.pdf`);
    };
            ...
            <div className="flex flex-col gap-6 h-full">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 w-full">
                    <div className="flex items-center gap-3 shrink-0">
                        ...
                        <div>
                            <h1 className="text-xl md:text-2xl font-bold tracking-tight text-foreground">UPI Reports</h1>
                            <p className="text-xs md:text-sm text-muted-foreground">View your UPI Payments history.</p>
                        </div>
                    </div>

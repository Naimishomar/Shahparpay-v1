            ...
            <div className="flex flex-col gap-6 h-full">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight text-foreground">UPI Reports</h1>
                            <p className="text-sm text-muted-foreground">View your UPI Payments history.</p>
                        </div>
                    </div>

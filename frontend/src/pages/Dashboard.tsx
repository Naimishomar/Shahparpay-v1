import { Banknote, Smartphone, Fingerprint, Building2, Receipt, Wallet, IndianRupee, Users, CreditCard, FileText } from "lucide-react";
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7 mt-8">
                <div className="lg:col-span-4 glass-card rounded-2xl p-6 min-h-[400px] flex flex-col">
                    ...
                    <div className="grid grid-cols-2 gap-4 h-full">
                        ...
                        <div onClick={() => navigate('/itr')} className="p-6 rounded-2xl bg-gradient-to-br from-indigo-500/10 to-indigo-600/10 border border-indigo-500/20 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-indigo-500/20 transition-all hover:scale-105 group">
                            ...
                            <h4 className="font-bold text-lg mb-1">ITR Filing</h4>
                            <p className="text-xs text-muted-foreground">Income Tax Return</p>
                        </div>
                    </div>
                </div>
